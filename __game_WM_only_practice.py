...
correct_answer_message = visual.TextStim(expWindow, pos=[0, -15], text="Richtig!", font='Courier New', bold=True,
                                         color="DarkGreen", height=50, alignHoriz='center', units=u'pix')
false_answer_message = visual.TextStim(expWindow, pos=[0, -15], text="Falsch!", font='Courier New', bold=True,
                                       color=(1.0, -1, -1), height=50, alignHoriz='center', units=u'pix')
time_up_message = visual.TextStim(expWindow, pos=[0, -15], text="Die Zeit ist um!", font='Courier New', bold=True,
                                  color=(1.0, -1, -1), height=35, alignHoriz='center', units=u'pix')
